jQuery(document).ready(function() {
    ...
    subscriptionForm.submit(function(e){
        ...
        jQuery.ajax({
            ...
            success: function(data){
                ...
                jQuery('.subscribe-form').addClass('subscribe-form__success');
    ...
    var floatingTopWaypoint = jQuery('.postmain').waypoint(function(direction){
        if(direction == "down"){
            ...
            jQuery('#map').removeClass('visible');
    ...
    var floatingBottomWaypoint = jQuery('footer').waypoint(function(direction){
        if(direction == "down"){
            bottomInView = true;
            // jQuery('.postreadingtime').removeClass('postreadingtime__visible');
            jQuery('#map').removeClass('visible');
